...
3) Configure
   ...
   > 💡 **Tip:** You can use our [Config Generator](https://xinbot.shouldbe.top/guide/config-generator) on the official website to easily create your configuration file.
...
7) Develop Plugins
   Add features with plugins. See the [Plugin Development Reference](https://xinbot.shouldbe.top/reference/).
...
- Can I write my own plugins?  
  Yes — Xinbot exposes a simple, Bukkit-style event system to build on. For details, see the [Plugin Development Reference](https://xinbot.shouldbe.top/zh/reference/)
