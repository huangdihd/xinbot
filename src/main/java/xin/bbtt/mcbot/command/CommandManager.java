...
public class CommandManager {
    ...
    public void callCommand(String command) {
        ...
        if (registeredCommand == null) {
            log.warn(commandErrorMarker, xin.bbtt.mcbot.LangManager.get("command.not.found.error", label));
            return;
        }
        ...
        try {
            ...
            log.error(commandErrorMarker, xin.bbtt.mcbot.LangManager.get("command.execute.error", command), e);
        }
    }
    ...
    public List<String> callComplete(String command) {
        ...
        try {
            ...
            log.error(commandErrorMarker, xin.bbtt.mcbot.LangManager.get("command.complete.error", command), e);
        }
        return List.of();
    }
